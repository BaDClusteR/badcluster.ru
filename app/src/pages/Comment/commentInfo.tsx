...
import {CommentDetailed, CommentDetailedContext} from "@/pages/Comment/types.ts";
...
export default function renderCommentInfo(
  _form: UseFormReturnType<CommentDetailed, CommentDetailed, (values: CommentDetailed) => FormErrors>,
  options: EntityFormRenderOptions<CommentDetailedContext>
): ReactNode {
