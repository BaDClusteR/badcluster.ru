...
interface SimpleImageFieldProps {
  label?: string;
...
/**
 * Simplified ImageField: no alt/caption editing, no thumbnail preview —
 * always shows the original image. onChange receives the MediaData as
 * returned by the upload endpoint (original dimensions, alt may be empty).
 */
